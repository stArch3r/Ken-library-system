...
$totalBorrowedBook = BorrowedBook::find()->asArray()->all();
$totalBorrowedBook = BorrowedBook::find()->asArray()->all();
$totalStudent = Student::find()->asArray()->all();
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?= count($totalBorrowedBook)?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?= count($totalStudent)?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
